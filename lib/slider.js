...
var _responsive = require('./mixins/responsive');
...
var Slider = exports.Slider = (0, _responsive2.default)(_class = function (_React$Component) {
  ...
  function Slider() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.innerSlider = null, _this.state = {
      breakpoint: null
    }, _this.refHandlers = {
